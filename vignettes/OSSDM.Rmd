---
title: "OSSDM: Optimized Stacked Species Distribution Models with R"
date: "`r Sys.Date()`"
output:
  html_document:
    theme: journal
...
![Figure 1.  Flow chart of the package ‘SSDM’](OSSDM/workflow.png){width=100%}
...
library(OSSDM)
Env <- load_var(system.file('extdata',  package = 'OSSDM'), categorical = 'SUBSTRATE', verbose = FALSE)
Env
```
