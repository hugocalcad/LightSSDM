...
#'  linear model (\strong{GLM}), Generalized additive model (\strong{BAM}),
#'  Multivariate adaptive regression splines for large dataset(\strong{MARS}),
...
#'  additive expansion. By default, set to 00.}}
#'
